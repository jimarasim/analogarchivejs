...
async function handleB2FolderEndpoint(folderName, req, res) {
    try {
        ...
        let fileNames = `<html><head><title>ananlogarchivejs - ${folderName.charAt(0).toUpperCase() + folderName.slice(1)}</title><link rel="stylesheet" href="styles.css"></head><body><div class="container">`;
